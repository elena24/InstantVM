...
public class AWSClients {
	...
	public static final AmazonCloudFormationClient CLOUDFORMATION = new AmazonCloudFormationClient(AWS_CREDENTIALS);

	static {
		DDB.setEndpoint(Configuration.AWS_DDB_ENDPOINT);
		EC2.setEndpoint(Configuration.AWS_EC2_ENDPOINT);
		CLOUDFORMATION.setEndpoint(Configuration.AWS_CLOUDFORMATION_ENDPOINT);
	}
